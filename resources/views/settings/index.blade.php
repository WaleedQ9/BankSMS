    ...
    <form method="POST" action="{{ route('settings.update') }}">
        ...
        <div class="card-main">
            ...
            <div class="mb-3">
                ...
                <input type="password" name="gemini_api_key" class="form-control" value="{{ $settings['gemini_api_key'] }}"
                    dir="ltr" style="font-size:0.8rem;" placeholder="AIza...">
        ...
        <div class="card-main">
            ...
            <div class="mb-3">
                ...
                <select name="overage_source_category_id" class="form-select">
                    ...
                    @foreach ($allCategories as $cat)
                        <option value="{{ $cat->id }}" {{ $overageSourceCategoryId == $cat->id ? 'selected' : '' }}>
                            {{ $cat->icon }} {{ $cat->name }}</option>
                    @endforeach
                </select>
    ...
    <div class="card-main">
        ...
        <form method="POST" action="{{ route('settings.updateShared') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="shared_pin" class="form-control" value="{{ $sharedPin }}" dir="ltr"
                    inputmode="numeric" placeholder="مثال: 1234"
        ...
        @if ($sharedPin)
            <div style="margin-top:8px;padding:10px;background:#F3F1EE;border-radius:10px;text-align:center;">
                ...
                <div dir="ltr" style="font-size:0.75rem;font-weight:600;word-break:break-all;">{{ url('/shared') }}
                </div>
            </div>
        @endif
